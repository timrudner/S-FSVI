"""
Based on the hyerparameter search
https://www.notion.so/Hyperparameter-v2-5ef0c69bc9bd4e6b8688326ee8ca51ed
"""
...
CL_TEMPLATE = ConfigTemplate(add_args_fn=add_cl_args)
