...
class Initializer:
    ...
    def initialize_optimizer(self, learning_rate=None) -> optax.GradientTransformation:
        _learning_rate = self.hparams.learning_rate if learning_rate is None else learning_rate
        opt = optax.adam(_learning_rate)
        return opt

    def initialize_inducing_input_fn(self, x_ood=None):
