...
def get_coreset_indices(
    ...
    if hparams.coreset == "random":
        print("Adding inducing inputs to the coreset randomly")
        ...
        print(
            f"Adding inducing inputs to the coreset randomly, {len(inds_add)} samples in total, "
            f"with each class getting the same number of samples"
        )
    elif hparams.coreset == "entropy":
        print("Adding inducing inputs to the coreset based on predictive entropy")
        options = {
        ...
        if task_id == 0:
            ...
            print(f"Adding inducing inputs to the coreset based on {hparams.coreset}")
            ...
            # kl_fn is a function of prior_mean, prior_cov, inputs, inducing_inputs
