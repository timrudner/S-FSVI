...
V1_TO_V2_RENAME = {
    ...
    "inducing_input_augmentation": "context_point_adjustment",
...
def add_sfsvi_args_v2(parser):
  ...
  parser.add_argument(
      "--prior_mean", type=str, default="0",
      help="Prior mean function (default: 0)"
  )

  parser.add_argument(
      "--prior_cov", type=str, default="0",
  ...
  parser.add_argument(
      "--kl_scale", type=str, default="1",
      help="KL scaling factor (default: 1)"
  )

  parser.add_argument(
      "--feature_map_jacobian", action="store_true", default=False,
      help="Use Jacobian feature map (default: False)"
  )

  parser.add_argument(
      "--feature_map_jacobian_train_only", action="store_true", default=False,
      help="Do not use Jacobian feature map at evaluation time (default: False)"
  )

  parser.add_argument(
      "--feature_map_type", type=str, default=NOT_SPECIFIED,
      help="Feature map update type (default: not_specified)"
  )

  parser.add_argument(
      "--td_prior_scale", type=float, default=0.0,
  ...
  parser.add_argument(
      "--full_cov", action="store_true", default=False,
      help="Use full covariance"
  )
  ...
  parser.add_argument(
      "--noise_std", type=float, default=1,
      help="Likelihood variance (default: 1)"
  )

  parser.add_argument(
      '--ind_lim', type=str, default='ind_-1_1',
  ...
  parser.add_argument(
      '--name', type=str, default='', help='Name (default: '')', nargs='?',
      const='',
  )
  ...
  parser.add_argument(
      "--resume_training", action="store_true", default=False,
      help="Resume training, this argument has deprecated."
  )

  parser.add_argument(
      "--no_final_layer_bias", action="store_true", default=False,
      help="No bias term in final layer (default: False)"
  )

  parser.add_argument(
      "--extra_linear_layer", action="store_true", default=False,
      help="additional linear penultimate layer"
  )

  parser.add_argument(
      "--map_initialization", action="store_true", default=False,
  ...
  parser.add_argument(
      "--grad_flow_jacobian", action="store_true", default=False,
      help="Gradient flow through Jacobian evaluation (default: False)"
  )

  parser.add_argument(
      '--stochastic_prior_mean', type=str, default='not_specified',
      help='Stochastic prior mean (default: not_specified)'
  )

  parser.add_argument(
      "--batch_normalization", action="store_true", default=False,
      help="Batch normalization"
  )

  parser.add_argument(
      '--batch_normalization_mod', type=str, default='not_specified',
  ...
  parser.add_argument(
      '--kl_sup', type=str, default='not_specified',
      help='Type of KL supremum estimation (default: not_specified)'
  )

  parser.add_argument(
      "--kl_sampled", action="store_true", default=False,
      help="Use Monte Carlo estimate of KL"
  )

  parser.add_argument(
      "--fixed_inner_layers_variational_var", action="store_true",
      default=False,
  ...
  parser.add_argument(
      "--perturbation_param", type=float, default=0.01,
  ...
  parser.add_argument(
      "--wandb_project", type=str, default=NOT_SPECIFIED,
  ...
  parser.add_argument(
      "--optimizer_var", type=str, default=NOT_SPECIFIED,
