...
def add_sfsvi_args(parser) -> None:
    ...
    parser.add_argument(
        ...
        type=float,
        default=0,
        help="Regularization parameter (default: 0), this parameter has deprecated.",
    )
