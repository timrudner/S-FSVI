...
def prepare_data(
    ...
    @param n_omniglot_coreset_chars: the number of inducing inputs per character, FRCL paper
    ...
    @return:
        ...
        n_coreset_inputs_per_task: a tuple of integers, the number of inducing points for each task
