...
FSVI_CONFIGS = [
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/fsvi_match.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/fsvi_optimized.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/fsvi_no_coreset.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/fsvi_minimal_coreset.pkl"),

	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/fsvi_cifar.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/fsvi_omniglot.pkl"),
]

BASELINES_CONFIGS = [
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/frcl_no_coreset.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/frcl_with_coreset.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/fromp_no_coreset.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/fromp_with_coreset.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/vcl_no_coreset.pkl"),
	os.path.join(PROJECT_ROOT, "sfsvi/exps/publish/configs/vcl_random_coreset.pkl"),
]
	...
	for group in gexps:
		...
		for ts in gexps[group]:
			if not gexps[group][ts]:
				...
				continue
			df = lutils.report_test_accuracies(gexps[group][ts], test_func=get_test_callable(group))
